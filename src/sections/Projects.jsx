...
export const Projects = () => {
  ...
  const projects = [
    {
      title: t.projects.items.plantDisease.title,
      description: t.projects.items.plantDisease.description,
      image: "/projects/ai-plant.png",
      link: "https://github.com/Eya-jomli/Plant-disease-AI",
      tags: ["React", "Django", "Ai"],
    },
    {
      title: t.projects.items.cms.title,
      description: t.projects.items.cms.description,
      image: "/projects/cms.png",
      link: "https://github.com/Eya-jomli/cms-word-phrase-manager",
      tags: ["React", "Django", "Ai"],
    },
    {
      title: t.projects.items.registration.title,
      description: t.projects.items.registration.description,
              ...
              <div className="relative overflow-hidden aspect-video">
                ...
                <div
                  className="absolute inset-0 flex items-center
                             justify-center gap-4 opacity-0
